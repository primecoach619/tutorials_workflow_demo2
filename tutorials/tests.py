...
# - We will want to write more integration tests that require creating a tutorial object.
# - We can convert our test_create_tutorial() function into a fixture to do this.
# - Update the test_create_tutorial() function as follows:
@pytest.fixture
def new_tutorial(db):
